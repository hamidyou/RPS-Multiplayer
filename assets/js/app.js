$(document).ready(function () {
  ...
  p1ReadyRef.on('value', x => x.val() ? setText('#p1OppSel', 'Selected') : setText('#p1OppSel', 'Thnking...'))
  p2ReadyRef.on('value', x => x.val() ? setText('#p2OppSel', 'Selected') : setText('#p2OppSel', 'Thnking...'))
